...
def run_inference(model, category_index, image_path):
    if os.path.isdir(image_path):
        ...
        for i_path in image_paths:
            ...
            # Save the image without changing the file name
            # output_path = os.path.join("outputs", os.path.basename(i_path))
            output_path = os.path.join("D:/ltmnc2/JapaneseTextRecognition_/public/outputs", os.path.basename(i_path))
            plt.imshow(image_np)
